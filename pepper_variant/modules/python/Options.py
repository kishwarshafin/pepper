...
class PEPPERVariantCandidateFinderOptions(object):
    ...
    SNP_ALLELE_WEIGHT_COEF = 0.987776
    SNP_BIAS_TERM = -0.000552
    SNP_THRESHOLD = 0.001
    SNP_LOWER_FREQ_THRESHOLD = 0.10
    SNP_UPPER_FREQ = 0.4

    INSERT_ALT_FREQ_COEF = 0
    INSERT_NON_REF_PROB_COEF = 1.028087
    INSERT_ALLELE_WEIGHT_COEF = 0.000183
    INSERT_BIAS_TERM = 0.00019
    INSERT_THRESHOLD = 0.4
    IN_LOWER_FREQ_THRESHOLD = 0.10
    IN_UPPER_FREQ = 0.3

    DELETE_ALT_FREQ_COEF = 0
    DELETE_NON_REF_PROB_COEF = 0.065364
    DELETE_ALLELE_WEIGHT_COEF = 0.645708
    DELETE_BIAS_TERM = -0.005204
    DELETE_THRESHOLD = 0.4
    DEL_LOWER_FREQ_THRESHOLD = 0.20
