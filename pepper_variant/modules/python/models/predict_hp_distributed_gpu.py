    ...
    with torch.no_grad():
        for contig, contig_start, contig_end, chunk_id, images_hp1, images_hp2, position, index in data_loader:
            ...
            for i in range(0, ImageSizeOptionsHP.SEQ_LENGTH, TrainOptions.WINDOW_JUMP):
                ...
                base_prediction_hp1 = (inference_layers(output_base_hp1) * 100000).type(torch.IntTensor).to(device_id)
                base_prediction_hp2 = (inference_layers(output_base_hp2) * 100000).type(torch.IntTensor).to(device_id)
