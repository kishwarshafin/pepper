...
def test(data_file, batch_size, gpu_mode, transducer_model, num_workers, gru_layers, hidden_size, num_classes=ImageSizeOptions.TOTAL_LABELS):
    ...
    return {'loss': avg_loss, 'base_accuracy': base_accuracy, 'base_confusion_matrix': confusion_matrix}
