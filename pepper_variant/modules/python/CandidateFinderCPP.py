...
class CandidateFinderCPP:
    ...
    def find_candidates(self, bam_file_path, fasta_file_path, contig_name, region_start, region_end, positions, indices, predictions, type_predictions, base_label, type_label, freq_based, freq):
