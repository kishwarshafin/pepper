...
def small_chunk_stitch(reference_file_path, bam_file_path, contig, small_chunk_keys, haplotag, set_profile):
...
def find_candidates(input_dir, reference_file_path, bam_file, contig, sequence_chunk_keys, threads, haplotag, set_profile):
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=threads) as executor:
        ...
        futures = [executor.submit(small_chunk_stitch, reference_file_path, bam_file, contig, file_chunk, haplotag, set_profile)
