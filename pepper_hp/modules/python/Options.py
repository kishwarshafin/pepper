...
class CandidateFinderOptions(object):
    ...
    IN_ALT_PROB_THRESHOLD = 0.2
    IN_NON_REF_THRESHOLD = 0.2
    IN_LAST_CHANCE_THRESHOLD = 0.2
    IN_FREQ_THRESHOLD = 0.2

    DEL_ALT_PROB_THRESHOLD = 0.2
    DEL_NON_REF_THRESHOLD = 0.2
    DEL_LAST_CHANCE_THRESHOLD = 0.2
