...
class CandidateFinderOptions(object):
    ...
    SNP_ALT_PROB_THRESHOLD = 0.4
    SNP_NON_REF_THRESHOLD = 0.4
    SNP_LAST_CHANCE_THRESHOLD = 0.4
    SNP_FREQ_THRESHOLD = 0.1

    IN_ALT_PROB_THRESHOLD = 0.4
    IN_NON_REF_THRESHOLD = 0.4
    IN_LAST_CHANCE_THRESHOLD = 0.4
    IN_FREQ_THRESHOLD = 0.1

    DEL_ALT_PROB_THRESHOLD = 0.4
    DEL_NON_REF_THRESHOLD = 0.4
    DEL_LAST_CHANCE_THRESHOLD = 0.4
    DEL_FREQ_THRESHOLD = 0.1
