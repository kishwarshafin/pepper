...
class CandidateFinderOptions(object):
    ...
    INDEL_ALLELE_FREQ_THRESHOLD = 0.1
    ...
    IN_ALT_PROB_THRESHOLD = 0.9
    IN_NON_REF_THRESHOLD = 0.9
    IN_LAST_CHANCE_THRESHOLD = 0.9
    IN_FREQ_THRESHOLD = 0.2

    DEL_ALT_PROB_THRESHOLD = 0.9
    DEL_NON_REF_THRESHOLD = 0.9
    DEL_LAST_CHANCE_THRESHOLD = 0.9
    DEL_FREQ_THRESHOLD = 0.2

    SAFE_BASES = 20
    ALT_PROB_THRESHOLD = 0.3
