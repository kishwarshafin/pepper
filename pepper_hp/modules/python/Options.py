...
class CandidateFinderOptions(object):
    ...
    SNP_ALT_FREQ_COEF = 0.015088
    SNP_NON_REF_PROB_COEF = 0.017869
    SNP_ALLELE_WEIGHT_COEF = 0.970279
    SNP_BIAS_TERM = -0.000505
    SNP_THRESHOLD = 0.005

    INSERT_ALT_FREQ_COEF = 0.702962
    INSERT_NON_REF_PROB_COEF = 0.230457
    INSERT_ALLELE_WEIGHT_COEF = 0.356006
    INSERT_BIAS_TERM = -0.119596
    INSERT_THRESHOLD = -0.02929973175023934
    IN_FREQ_THRESHOLD = 0.10

    DELETE_ALT_FREQ_COEF = 0.015088
    DELETE_NON_REF_PROB_COEF = 0.017869
    DELETE_ALLELE_WEIGHT_COEF = 0.970279
    DELETE_BIAS_TERM = -0.000505
