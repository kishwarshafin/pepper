...
def small_chunk_stitch(input_dir, reference_file_path, contig, small_chunk_keys, hp_tag):
...
def find_candidates_basic(input_dir, reference_file_path, contig, sequence_chunk_keys, threads, hp_tag):
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=threads) as executor:
        ...
        futures = [executor.submit(small_chunk_stitch, input_dir, reference_file_path, contig, file_chunk, hp_tag)
