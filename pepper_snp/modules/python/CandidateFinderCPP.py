...
class CandidateFinderCPP:
    ...
    def find_candidates(self, bam_file_path, fasta_file_path, contig_name, region_start, region_end, all_positions, all_indicies, all_predictions):
        ...
        candidate_finder = PEPPER_SNP.CandidateFinder(reference_sequence,
                                                      ...
                                                      ref_end)
        # find candidates
        positional_candidate_list = candidate_finder.find_candidates(all_reads, all_positions, all_indicies, all_predictions)
