...
def polish_genome(csv_file, model_path, batch_size, num_workers, output_dir, gpu_mode, mkldnn_mode):
    ...
    predict(csv_file, output_filename, model_path, batch_size, num_workers, gpu_mode, mkldnn_mode)
