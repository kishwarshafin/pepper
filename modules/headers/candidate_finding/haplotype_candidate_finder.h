...
struct PositionalCandidateRecord{
    ...
    int alt1_type, int alt2_type, int alt1_count, int alt2_count) {
        ...
        this->alt1_count = alt1_count;
        this->alt2_count = alt2_count;
    }
    ...
    void set_alt1(string alt1, int alt1_type, int alt1_count) {
        this->alt1 = alt1;
        this->alt1_type = alt1_type;
        this->alt1_count = alt1_count;
    }

    void set_alt2(string alt2, int alt2_type, int alt2_count, long long pos_end) {
        this->alt2 = alt2;
        this->alt2_type = alt2_type;
        this->alt2_count = alt2_count,
