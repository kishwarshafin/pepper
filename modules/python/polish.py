...
def polish(bam_filepath, fasta_filepath, output_path, threads, region,
    ...
    image_output_directory = Path(output_parent_directory + "images_" + str(timestr)).resolve()
    prediction_output_directory = Path(output_parent_directory + "predictions_" + str(timestr)).resolve()
